            ...
            <div className="container mx-auto px-4 py-8">
              <div className="text-center space-y-8 mb-12">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up">
                  <Button
                    size="lg"
                    className="text-lg px-8 py-6 gradient-bg border-0 hover:scale-105 transition-transform"
              ...
              <div className="text-center">
                <Card className="max-w-2xl mx-auto border-0 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Rejoignez des milliers d'étudiants qui gèrent déjà leur budget avec Mbongou.App
                    </CardDescription>
                  </CardHeader>
